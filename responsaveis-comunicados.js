...
const listaResponsaveisComunicados =
  document.getElementById(
    "listaResponsaveisComunicados"
  );
...
async function carregarAssociados() {
  ...
  listaResponsaveisComunicados.innerHTML =
    "";
  ...
  associadosCarregados.forEach(
    (associado) => {
      ...
      listaResponsaveisComunicados.appendChild(
        criarItemAssociado(
          associado
        )
      );
...
async function salvarResponsaveis() {
  ...
  try {
    ...
    console.error(
      "Erro ao salvar responsáveis de Recados e Enquetes:",
      erro
    );
...
async function iniciarPagina() {
  ...
  try {
    ...
    console.error(
      "Erro ao carregar responsáveis de Recados e Enquetes:",
      erro
    );
