...
const listaAtividadesEditar =
  document.getElementById(
    "listaAtividadesEditar"
  );

const mensagemSemAtividadesEditar =
  document.getElementById(
    "mensagemSemAtividadesEditar"
  );
...
function criarItemAtividade(
  ...
  link.href =
    `editar-atividade-form.html?id=${atividade.id}`;
...
async function carregarAtividades() {
  ...
  try {
    ...
    listaAtividadesEditar.innerHTML =
      "";


    mensagemSemAtividadesEditar.hidden =
      atividades.length > 0;
    ...
    atividades.forEach(
      (atividade) => {
        ...
        listaAtividadesEditar.appendChild(
          criarItemAtividade(
            atividade
          )
        );
